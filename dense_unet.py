...
class Dense_Unet(nn.Module):
    def __init__(self, in_chan, out_chan, filters, num_conv = 4):
        ...
        self.d1 = Single_level_densenet(filters,6 )
        self.down1 = Down_sample()
        self.d2 = Single_level_densenet(filters,12 )
        self.down2 = Down_sample()
        self.d3 = Single_level_densenet(filters,24 )
        self.down3 = Down_sample()
        self.d4 = Single_level_densenet(filters,16 )
        self.down4 = Down_sample()
        self.bottom = Single_level_densenet(filters,16 )
        self.up4 = Upsample_n_Concat(filters)
        self.u4 = Single_level_densenet(filters,16 )
        self.up3 = Upsample_n_Concat(filters)
        self.u3 = Single_level_densenet(filters,24 )
        self.up2 = Upsample_n_Concat(filters)
        self.u2 = Single_level_densenet(filters,12 )
        self.up1 = Upsample_n_Concat(filters)
        self.u1 = Single_level_densenet(filters,6 )
